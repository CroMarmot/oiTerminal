...
from oiTerminal.utils.start_terminal import start_terminal


def createDir(oj: BaseOj, problem_id: str, file_util: Type[FileUtil], logger, template_manager: TemplateManager, config_folder: ConfigFolder):
    ...
    RELATIVE_CLI_FOLDER = '../../../../oiTerminal/cli/'
...
def main(argv: List[str], logger: logging, folder='.oiTerminal'):
    ...
    account_manager = AccountManager(db=dbIns, cipher=AESCipher(key))
